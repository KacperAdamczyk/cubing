...
export const Face: FC<Props> = ({
  ...
  return (
    ...
    >
        {adjacentPieces && (
            <>
                ...
                <Piece
                    ...
                    color={maskColor(
                        adjacentPieces.Left[0],
                        maskedAdjPieces?.Left?.[0],
                    )}
                />
            </>
        )}
        ...
        {adjacentPieces && (
            <>
                ...
                <Piece
                    ...
                    color={maskColor(
                        adjacentPieces.Left[1],
                        maskedAdjPieces?.Left?.[1],
                    )}
                />
            </>
        )}
      ...
      {!!faceLabel && (
          <div
              className="text-default-400 relative col-start-3 row-start-3 flex select-none items-center justify-center text-2xl font-bold">
          {faceLabel}
        </div>
      )}
        ...
        {adjacentPieces && (
            <>
                ...
                <Piece
                    ...
                    color={maskColor(
                        adjacentPieces.Left[2],
                        maskedAdjPieces?.Left?.[2],
                    )}
                />
            </>
        )}
