...
export const getAdjacentPieces = <Value>(
  ...
  return match(upFace)
    ...
    .with(Faces.B, () => ({
      ...
      Right: [faces[Faces.R][2][2], faces[Faces.R][1][2], faces[Faces.R][0][2]],
      Top: [faces[Faces.B][0][2], faces[Faces.B][0][1], faces[Faces.B][0][0]],
      Left: [faces[Faces.L][2][0], faces[Faces.L][1][0], faces[Faces.L][0][0]],
    }))
    .with(Faces.R, () => ({
      ...
      Right: [faces[Faces.B][2][2], faces[Faces.B][1][2], faces[Faces.B][0][2]],
    }))
    .with(Faces.L, () => ({
      ...
      Left: [faces[Faces.B][2][0], faces[Faces.B][1][0], faces[Faces.B][0][0]],
    }))
    .exhaustive();
};
